...
| ----------- | ----------- |
| Specialty Coffee | Worked part time as a barista serving sepcialty blends and single origin espresso in a high end district. I can 
*operate an espresso machine 
*make all basic forms of latte art 
*calibrate the grind of beans according to humidity and temperature of the day |
| Branding Consultant and Designer  | Assisted a start up in a complete rebranding and created: 
*brand narrative, 
